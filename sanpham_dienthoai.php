...
<body>
	<div class="LapTop">
		<div class="container">
			<div class="Title">
				<h1 class="text-center" style="color: #D10024; padding-top: 10px;">SẢN PHẨM ĐIỆN THOẠI</h1>
			</div>
			<div class="DanhSachSanPham">
				<div class="SanPham">
					...
					<div class="row">
						<?php 
						$SanPham = mysqli_query($Connect,"SELECT a.*,(SELECT b.HSP_TenTapTin FROM hinhsanpham b WHERE a.SP_Ma = b.SP_Ma ORDER BY HSP_TenTapTin LIMIT 0,1) AS AvatarSP, LSP_Ten, c.LSP_Ma FROM sanpham a JOIN loaisanpham c ON a.LSP_Ma = c.LSP_Ma WHERE c.LSP_Ma = 3");
