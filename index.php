			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						<li><a href="#"><i class="fa fa-phone"></i> 0981 424 285</a></li>
						<li><a href="#"><i class="fa fa-envelope-o"></i> NguyenPCGCC18074@fpt.edu.vn</a></li>
						<li><a href="#"><i class="fa fa-map-marker"></i> Cần Thơ</a></li>
						<li><a href="https://www.instagram.com/pham.c.nguyen.37/"><i class="fa fa-instagram"></i> Instagram</a></li>
						<li><a href="https://www.facebook.com/pham.c.nguyen.37/"><i class="fa fa-facebook"></i>Facebook</a></li>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="newsletter">
							...
							<ul>
                            <li><a href="#"><p><strong>Google Maps</strong></p></a></li>
